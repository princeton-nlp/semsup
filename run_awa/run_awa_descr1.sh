...
ARGS="--train --default_config $CONFIG_FOLDER/awa_default.yaml --data.args.train_label_json ../class_descrs/awa/google_awa_manual_train_descr1.labels --seed $SEED --name_suffix descr1_s$SEED"
